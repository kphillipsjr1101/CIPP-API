...
Adds a new standard enforcement script or updates an existing one for compliance or automation.
...
- Create or update a script in Modules/CIPPStandards/Public/Standards/...
- Optionally update related core logic or helper modules.
- Commit the new or changed standard file.
